...
spec:
  ...
  remoteWrite:
    url: "http://demo-influxdb.default:8086/api/v1/prom/write?u=admin&p=admin&db=prometheus"
  remoteRead:
    url: "http://demo-influxdb.default:8086/api/v1/prom/read?u=admin&p=admin&db=prometheus"
  ruleSelector:
    matchLabels:
